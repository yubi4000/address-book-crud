        ...
        <div class="row col-md-12 col-md-offset-0">
            ...
            <form method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="zip_code" value="<?= htmlspecialchars($details['zip_code'] ?? '') ?>" required>
                ...
                <div class="form-group">
                    <label>Email:</label>
                    <input type="text" class="form-control" name="email" value="<?= htmlspecialchars(strtolower($details['email'] ?? '')) ?>" required>
                ...
                <div class="form-group">
                    <label>Phone 1:</label>
                    <input type="text" class="form-control" name="phone_1" value="<?= htmlspecialchars($details['phone_1'] ?? '') ?>" required>
